...
RUN yum -y update && yum -y install epel-release wget && yum -y install R mariadb-libs mariadb-devel multitail && yum clean all
...
ENV R_SHINY_SERVER_VERSION 1.5.14.948
